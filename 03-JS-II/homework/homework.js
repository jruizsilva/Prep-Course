...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (num3 > num1 && num3 > num1) return ++num3;
  return false;
}
...
function esPrimo(numero) {
  ...
  for (let i = 2; i <= Math.abs(numero); i++) {
    if (Math.abs(numero) % i === 0 && i !== Math.abs(numero)) return false;
    if (i === Math.abs(numero)) return true;
  }
}
